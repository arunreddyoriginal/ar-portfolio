      ...
      <div className="section-container flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-[var(--text-secondary)]">
            arunreddy.co — AI Workflow & Agentic AI Architect
          </span>
        </div>

        <div className="flex items-center gap-5">
          <a
            href="https://linkedin.com/in/arunreddy-co"
            target="_blank"
          ...
          <a
            href="https://github.com/arunreddy-co/genai-projects"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors"
            aria-label="GitHub"
        ...
        <p className="text-xs text-[var(--text-muted)]">
          © {new Date().getFullYear()} Arun Reddy. All rights reserved.
        </p>
      </div>
    </footer>
  );
